...
<%@ Page language="c#" Codebehind="CreateDatabase.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.CreateDatabase" %>
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td valign="bottom" align="right" width="100%">
									<Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="createdatabase"></Toolbar:HelpLogout>
								</td>
							</tr>
						</table>
					</td>
										...
										<tr>
											<td bgcolor="white" class="databaseListItem">
												...
												<asp:Button id="CreateNewDatabaseButton" runat="server" CSSClass="button" onMouseOver="this.style.color='#808080';"
													onMouseOut="this.style.color='#000000';" Text="创建" onclick="CreateNewDatabaseButton_Click"></asp:Button>
												<br>
												<br>
