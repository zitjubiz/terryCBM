<%@ Page language="c#" Codebehind="CreateTable.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.CreateTable" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<FORM id="CreateTable" method="post" runat="server">
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td valign="bottom" align="right" width="100%">
									<Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="createtable"></Toolbar:HelpLogout>
								</td>
							</tr>
						</table>
					</td>
										...
										<tr>
											<td bgcolor="white" class="databaseListItem">
												...
												<asp:Button id="CreateNewTableButton" runat="server" CSSClass="button" onMouseOver="this.style.color='#808080';"
													onMouseOut="this.style.color='#000000';" Text="创建" onclick="CreateNewTableButton_Click"></asp:Button>
												<br>
												<br>
