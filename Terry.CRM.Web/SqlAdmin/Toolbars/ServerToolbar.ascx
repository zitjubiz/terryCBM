	...
	<tr>
		<td id="DatabasesTd" height="20" runat="server">
			<asp:HyperLink id="DatabasesHyperLink" CssClass="leftMenu" onMouseOver="this.style.color='#ffffff';"
				onMouseOut="this.style.color='#000000';" runat="server"><img src="images/db_ico.gif" align="Absmiddle" border="0">&nbsp;数据库</asp:HyperLink>
		</td>
	</tr>
	<!-- SECTION ITEM: END -->
	<!-- SECTION ITEM: START -->
	<tr>
		<td id="ImportTd" height="20" runat="server">
			<asp:HyperLink id="ImportHyperLink" CssClass="leftMenu" onMouseOver="this.style.color='#ffffff';"
				onMouseOut="this.style.color='#000000';" runat="server"><img src="images/wizards_ico.gif" align="Absmiddle" border="0">&nbsp;导入</asp:HyperLink>
		</td>
	</tr>
	<!-- SECTION ITEM: END -->
	<!-- SECTION ITEM: START -->
	<tr>
		<td id="ExportTd" height="20" runat="server">
			<asp:HyperLink id="ExportHyperLink" CssClass="leftMenu" onMouseOver="this.style.color='#ffffff';"
				onMouseOut="this.style.color='#000000';" runat="server"><img src="images/wizards_ico.gif" align="Absmiddle" border="0">&nbsp;导出</asp:HyperLink>
		</td>
	</tr>
	<!-- SECTION ITEM: END -->
	<!-- SECTION ITEM: START -->
	<tr>
		<td id="SecurityTd" height="20" runat="server">
			<asp:HyperLink id="SecurityHyperLink" CssClass="leftMenu" onMouseOver="this.style.color='#ffffff';"
				onMouseOut="this.style.color='#000000';" runat="server"><img src="images/serverroles_ico.gif" align="Absmiddle" border="0">&nbsp;安全</asp:HyperLink>
		</td>
	</tr>
	<!-- SECTION ITEM: END -->
</table>
