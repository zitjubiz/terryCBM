...
<%@ Page language="c#" Codebehind="QueryDatabase.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.query" %>
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										...
										<tr>
											<td bgcolor="white" class="databaseListItem">
												<table cellspacing="0" cellpadding="0" border="0">
													...
													<tr>
														...
														<td class="databaseListItem" align="right">
															<asp:Button Runat="server" Text="执行" CSSClass="button" onMouseOver="this.style.color='#808080';"
																onMouseOut="this.style.color='#000000';" ID="ExecuteButton" onclick="ExecuteButton_Click"></asp:Button>
															<asp:Button Runat="server" Text="保存" CSSClass="button" onMouseOver="this.style.color='#808080';"
																onMouseOut="this.style.color='#000000';" ID="SaveButton" onclick="SaveButton_Click"></asp:Button>
														</td>
													</tr>
												</table>
												<br>
												...
												<br>
												<br>
												<asp:Button Runat="server" Text="载入" CSSClass="button" onMouseOver="this.style.color='#808080';"
													onMouseOut="this.style.color='#000000';" ID="LoadButton" onclick="LoadButton_Click"></asp:Button>
												<br>
												<br>
