<%@ Page language="c#" Codebehind="EditDatabaseUser.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.EditDatabaseUser" %>
                                    ...
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        <tr>
                                            <td class="databaseListHeader">
                                                EDIT USER <asp:Label ID="UsernameLabel" Runat="server"/>
                                            </td>
                                        </tr>
                                        <!-- SECTION HEADER: END -->
                                        <!-- SECTION: START -->
