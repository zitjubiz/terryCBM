...
<%@ Page language="c#" Codebehind="RenameTable.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.RenameTable" %>
...
<HTML>
  <HEAD>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
        <FORM id="RenameTable" method="post" runat="server">
                        ...
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td valign="bottom" align="right" width="100%">
                                    <Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="renametable"></Toolbar:HelpLogout>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td bgcolor="white" class="databaseListItem">
                                                ...
                                                <asp:Button Runat="server" ID="RenameButton" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';" Text="Rename" onclick="RenameButton_Click"></asp:Button>
                                                <asp:Button Runat="server" ID="CancelButton" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';" Text="Cancel" CausesValidation="false" onclick="CancelButton_Click"></asp:Button>
                                                <br>
                                                <br>
                                                <asp:RequiredFieldValidator Runat="server" ID="TableNameRequiredValidator" ControlToValidate="TableNameTextBox" Display="Dynamic" ErrorMessage="The table name cannot be empty."></asp:RequiredFieldValidator>
