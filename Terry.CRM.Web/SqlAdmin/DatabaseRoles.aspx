<%@ Page language="c#" Codebehind="DatabaseRoles.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.DatabaseRoles" %>
            ...
            <TABLE width="100%" height="100%" cellSpacing="0" cellPadding="0" border="0">
                        ...
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td valign="bottom" align="right" width="100%">
                                    <Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="DatabaseRoles"></Toolbar:HelpLogout>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    ...
                    <td bgcolor="#6699ff" valign="top" align="middle" width="172" height="100%">
                        ...
                        <Toolbar:Database Selected="Roles" Runat="server" ID="DatabaseToolbar">
                        </Toolbar:Database>
                    </td>
                                            ...
                                            <td bgcolor="white" class="databaseListItem">
												...
												>
													...
													<Columns>
														...
														<asp:TemplateColumn>
															<ItemTemplate>
																<a href=EditDatabaseRole.aspx?database=<%=Request["database"]%>&role=<%#((SqlDatabaseRole)Container.DataItem).Name%>>Edit</a>
															</ItemTemplate>
														</asp:TemplateColumn>
														<%--
														<asp:TemplateColumn>
