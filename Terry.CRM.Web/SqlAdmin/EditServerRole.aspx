<%@ Page language="c#" Codebehind="EditServerRole.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.EditServerRole" %>
                        ...
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td valign="bottom" align="right" width="100%">
                                    <Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="ServerRoles"></Toolbar:HelpLogout>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellSpacing="0" cellPadding="0" border="0">
                                        <tr>
                                            <td class="databaseListHeader">
                                                EDITING ROLE <asp:Label ID="RoleLabel" Runat="server"/>
                                            </td>
                                        </tr>
                                        <!-- SECTION HEADER: END -->
                                        ...
                                        <tr>
                                            <td bgcolor="white" class="databaseListItem">
												Select which logins are assigned to this role:<br/><br/>
