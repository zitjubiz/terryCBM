...
<%@ Page language="c#" Codebehind="CreateDatabaseUser.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.CreateDatabaseUser" %>
												...
												<table border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														...
														<td class="databaseListItem">
															...
															<asp:RequiredFieldValidator ControlToValidate="Username" ErrorMessage="* Required" Display="Dynamic" Runat="server"
																id="RequiredFieldValidator1" />
														</td>
													</tr>
													<tr>
														<td colspan="2" align="right">
															<asp:Button ID="CreateButton" Text="建立用户" OnClick="Create_Click" Runat="server" />
														</td>
													</tr>
												</table>
												<br>
