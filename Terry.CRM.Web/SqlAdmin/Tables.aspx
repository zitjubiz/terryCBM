...
<%@ Page language="c#" Codebehind="Tables.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.Tables" %>
						...
						<table cellSpacing="0" cellPadding="0" border="0" width="100%">
							...
							<tr>
								...
								<td align="left" class="databaseListItem" width="100%">
									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td class="databaseListHeader" height="21">
												表
											</td>
										</tr>
										<!-- SECTION HEADER: END -->
											...
											<td bgcolor="white" class="databaseListItem">
												<table width="100%" cellspacing="0" cellpadding="0" border="0">
													<tr>
														<td>
															...
															<asp:Button id="FilterTablesButton" runat="server" Text="选择" CSSClass="button" onMouseOver="this.style.color='#808080';"
														...
														<td align="right">
															<asp:HyperLink Runat="server" CssClass="createLink" ID="AddNewTableHyperLink">
																...
																<span style="position:relative; top: -3px;">建立新表</span>
															</asp:HyperLink>
														</td>
													</tr>
												</table>
												...
												<asp:datagrid id="TablesDataGrid" runat="server" GridLines="None" Border="0" AutoGenerateColumns="False"
													...
													<Columns>
														...
														<asp:TemplateColumn HeaderText="所有者">
															<HeaderStyle Wrap="False"></HeaderStyle>
															<ItemStyle Wrap="False"></ItemStyle>
															<ItemTemplate>
														...
														<asp:BoundColumn DataField="createdate" HeaderText="建立日期" DataFormatString="{0}">
															<HeaderStyle Wrap="False"></HeaderStyle>
															<ItemStyle Wrap="False"></ItemStyle>
														</asp:BoundColumn>
														<asp:BoundColumn DataField="rows" HeaderText="行" DataFormatString="{0}">
														...
														<asp:TemplateColumn HeaderText="编辑">
															...
															<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
															<ItemTemplate>
																<asp:HyperLink id=EditTable runat="server" NavigateUrl='<%# String.Format("columns.aspx?database={0}&amp;table={1}", Server.UrlEncode(Request["database"]), DataBinder.Eval(Container.DataItem, "encodedname")) %>' cssclass="databaseListAction" text="edit">编辑</asp:HyperLink>
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:TemplateColumn HeaderText="改名">
															<HeaderStyle Wrap="False" HorizontalAlign="Right"></HeaderStyle>
															<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
															<ItemTemplate>
																<asp:HyperLink id=RenameHyperLink runat="server" NavigateUrl='<%# String.Format("renametable.aspx?database={0}&amp;table={1}", Server.UrlEncode(Request["database"]), DataBinder.Eval(Container.DataItem, "encodedname")) %>' cssclass="databaseListAction" text="rename">改名</asp:HyperLink>
															</ItemTemplate>
														</asp:TemplateColumn>
														<asp:TemplateColumn HeaderText="删除">
															...
															<ItemStyle Wrap="False" HorizontalAlign="Right"></ItemStyle>
															<ItemTemplate>
																<asp:HyperLink id=DeleteTable runat="server" NavigateUrl='<%# String.Format("deletetable.aspx?database={0}&amp;table={1}", Server.UrlEncode(Request["database"]), DataBinder.Eval(Container.DataItem, "encodedname")) %>' cssclass="databaseListAction" text="delete">删除</asp:HyperLink>
															</ItemTemplate>
														</asp:TemplateColumn>
													</Columns>
												</asp:datagrid>
