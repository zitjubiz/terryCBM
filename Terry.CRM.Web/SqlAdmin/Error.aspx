...
<%@ Page language="c#" Codebehind="Error.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.Error" %>
                        ...
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td valign="bottom" align="right" width="100%">
                                    <Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="error"></Toolbar:HelpLogout>
                                </td>
                            </tr>
                        </table>
                    </td>
