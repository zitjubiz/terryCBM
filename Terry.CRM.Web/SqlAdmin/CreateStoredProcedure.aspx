...
<%@ Page language="c#" Codebehind="CreateStoredProcedure.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.CreateStoredProcedure" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<FORM id="CreateStoredProcedure" method="post" runat="server">
										...
										<tr>
											<td bgcolor="white" class="databaseListItem">
												...
												<asp:Button id="CreateNewSProcButton" runat="server" CSSClass="button" onMouseOver="this.style.color='#808080';"
													onMouseOut="this.style.color='#000000';" Text="建立" onclick="CreateNewSProcButton_Click"></asp:Button>
												<br>
												<br>
