<%@ Page language="c#" Codebehind="DeleteDatabase.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.DeleteDatabase" %>
...
<HTML>
  <HEAD>
    ...
    <body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
        <FORM id="DeleteDatabase" method="post" runat="server">
                        ...
                        <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                            <tr>
                                ...
                                <td valign="bottom" align="right" width="100%">
                                    <Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="deletedatabase"></Toolbar:HelpLogout>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table cellSpacing="0" cellPadding="0" width="100%" border="0">
                                        ...
                                        <tr>
                                            <td bgcolor="white" class="databaseListItem">
                                                Are you sure you want to delete database <asp:Label id="DatabaseNameLabel" runat="server" Font-Bold="True"></asp:Label>?
                                                <br>
                                                <br>
