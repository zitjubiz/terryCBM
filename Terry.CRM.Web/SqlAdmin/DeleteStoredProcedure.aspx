<%@ Page language="c#" Codebehind="DeleteStoredProcedure.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.DeleteStoredProcedure" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<FORM id="DeleteStoredProcedure" method="post" runat="server">
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							<tr>
								...
								<td valign="bottom" align="right" width="100%">
									<Toolbar:HelpLogout Runat="server" id="HelpLogout" HelpTopic="deletestoredprocedure"></Toolbar:HelpLogout>
								</td>
							</tr>
						</table>
					</td>
