<%@ Page language="c#" Codebehind="DatabaseProperties.aspx.cs" AutoEventWireup="True" Inherits="SqlWebAdmin.DatabaseProperties" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0">
		<FORM id="DatabaseProperties" method="post" runat="server">
							...
							<TBODY>
								...
								<tr>
									...
									<td align="left" class="databaseListItem" width="100%">
										...
										<BR>
										<hr>
										<asp:button id="ApplyButton" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';"
											runat="server" Text="Apply" onclick="ApplyButton_Click"></asp:button>&nbsp;
										<asp:button id="CancelButton" CSSClass="button" onMouseOver="this.style.color='#808080';" onMouseOut="this.style.color='#000000';"
											runat="server" Text="Cancel" onclick="CancelButton_Click"></asp:button>&nbsp;
									</td>
					</td>
				</tr>
				<!-- Section END -->
