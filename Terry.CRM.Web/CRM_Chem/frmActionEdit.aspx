<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmActionEdit.aspx.cs"
    Inherits="Terry.CRM.Web.CRM.frmActionEdit_Chemical" MasterPageFile="~/MasterPage/Site.Master" %>
                            ...
                            <div class="DetailDt">
                                <table width="100%" cellpadding="1" cellspacing="1" style="border-collapse:collapse;">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtACTNextBuyDate" runat="server" AutoComplete="off" 
                                                onClick="WdatePicker({dateFmt:'yyyy-MM-dd'})" Width="220px">
                                            </asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
...
<cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                            ...
                            </cc1:PagingGridView></div>
                            <div style="float:right;width:25%;margin-left:10px;"><div class="head">交流意见</div>
                                <asp:TextBox ID="txtComment" runat="server" TextMode="MultiLine" Height="72px" 
                                    Width="229px"></asp:TextBox>
                                <asp:Button ID="btnComment" runat="server" Text ="发表意见" 
                    ...
                    <br/>
                        ...
                        <asp:Button ID="btnDel" Visible="false" runat="server" Text="<%$ Resources:re, lblDelete%>" OnClick="btnDel_Click" />
