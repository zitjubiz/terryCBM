...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmRole.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmRole"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="Role" Text="<%$ Resources:re, lblRole%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="RoleID" FooterStyle-CssClass="Foot"
