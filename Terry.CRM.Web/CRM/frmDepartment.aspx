<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmDepartment.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmDepartment"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="DepName" Text="<%$ Resources:re, lblDepName%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="DepID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="DepID"  SortExpression="DepID" HeaderText="<%$ Resources:re, lblID%>" Visible="false" />		
									<asp:BoundField DataField="DepName"  SortExpression="DepName" HeaderText="<%$ Resources:re, lblDepName%>" />		
									<asp:BoundField DataField="DepAddress"  SortExpression="DepAddress" HeaderText="<%$ Resources:re, lblAddress%>" />			
