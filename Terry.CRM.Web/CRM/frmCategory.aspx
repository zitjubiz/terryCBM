<%@ Page Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="frmCategory.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCategory" Title="" %>
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="Name" Text="<%$ Resources:re, lblName%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="CatID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="CatID"  SortExpression="CatID" HeaderText="<%$ Resources:re, lblID%>" Visible="false" />		
									<asp:BoundField DataField="Category"  SortExpression="Category" HeaderText="<%$ Resources:re, lblCategory%>" />		
