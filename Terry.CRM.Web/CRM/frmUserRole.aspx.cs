...
{
    public partial class frmUserRole : BasePage
    {
        private const string EditURL = "frmUserRoleEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria(typeof(CRMUserRole), gvData.PageIndex, base.GridViewPageSize, out recordCount, Filter, gvData.OrderBy);
