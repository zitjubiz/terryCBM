...
{
    public partial class frmActionEdit : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                lblCust.Text = new CustomerService().LoadById(Request["CustID"]).CustName;
                ...
                txtACTSubject.Text = lblActionType.Text;
        ...
        private void BindData()
        {
            ...
            if (entity != null)
            {
                ...
                if (entity.ACTType != null)
                {
                    ...
                    ddlActionType.SelectedByValue(entity.ACTTypeID.ToString());
                }
            ...
            else
            {
                ...
                ddlActionType.SelectedByValue(Request["ACType"]);
        ...
        protected void btnBack_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("frmAction.aspx?ACType=" + ActType + "&CustID=" + CustID);
        }
        ...
        {
            Response.Redirect("frmActionEdit.aspx?id=" + Request["id"] + "&ACType=" + ddlActionType.SelectedValue + "&CustID=" + Request["CustId"]);
        }
    }
}
