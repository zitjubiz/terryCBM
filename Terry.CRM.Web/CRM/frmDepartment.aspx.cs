...
namespace Terry.CRM.Web.CRM
{
    ...
    {
        private const string EditURL = "frmDepartmentEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "DepID":
                            Filter = " and DepID=" + ViewState["keyword"] + "";
                            break;
                        default:
            ...
            if (OrderBy == "")
                OrderBy = "DepID";
            DataTable ilist = svr.SearchByCriteria(typeof(CRMDepartment), gvData.PageIndex, base.GridViewPageSize, out recordCount, Filter, OrderBy);
