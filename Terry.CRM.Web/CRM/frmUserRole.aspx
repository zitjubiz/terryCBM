...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmUserRole.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmUserRole"
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="UserID" Text="<%$ Resources:re, lblUserID%>"></asp:ListItem>		
											<asp:ListItem Value="RoleID" Text="<%$ Resources:re, lblRoleID%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                ...
                                <Columns>
									...
									<asp:BoundField DataField="RoleID"  SortExpression="RoleID" HeaderText="<%$ Resources:re, lblRoleID%>" />		
