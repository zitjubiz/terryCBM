...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerEmpNum.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerEmpNum"
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="EmpNum" Text="<%$ Resources:re, lblEmpNum%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                ...
                                <Columns>
									...
									<asp:BoundField DataField="EmpNum"  SortExpression="EmpNum" HeaderText="<%$ Resources:re, lblEmpNum%>" />		
