...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerType.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerType"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="CustTypeID" Text="<%$ Resources:re, lblCustTypeID%>"></asp:ListItem>		
											<asp:ListItem Value="CustType" Text="<%$ Resources:re, lblCustType%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="CustTypeID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="CustTypeID"  SortExpression="CustTypeID" HeaderText="<%$ Resources:re, lblCustTypeID%>" />		
