...
{
    public partial class frmContactType : BasePage
    {
        private const string EditURL = "frmContactTypeEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria("CRMContactType" ,out recordCount, Filter, gvData.OrderBy);
