...
{
    public partial class frmCountry : BasePage
    {
        private const string EditURL = "frmCountryEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCountry",  out recordCount, Filter, gvData.OrderBy);
