...
{
    public partial class frmCustomerIndustry : BasePage
    {
        private const string EditURL = "frmCustomerIndustryEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "IndustryID":
                            Filter = "IndustryID=" + ViewState["keyword"] + "";
                            break;
                        default:
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerIndustry", out recordCount, Filter, gvData.OrderBy);
