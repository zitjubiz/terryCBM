...
{
    public partial class frmCustomerStatus : BasePage
    {
        private const string EditURL = "frmCustomerStatusEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerStatus", out recordCount, Filter, gvData.OrderBy);
