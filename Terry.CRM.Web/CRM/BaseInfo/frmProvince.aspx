...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmProvince.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmProvince"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="ProvinceID" Text="<%$ Resources:re, lblID%>"></asp:ListItem>		
											<asp:ListItem Value="Province" Text="<%$ Resources:re, lblCustProvince%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="ProvinceID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="ProvinceID"  SortExpression="ProvinceID" HeaderText="<%$ Resources:re, lblID%>" />		
									<asp:BoundField DataField="Province"  SortExpression="Province" HeaderText="<%$ Resources:re, lblCustProvince%>" />		
