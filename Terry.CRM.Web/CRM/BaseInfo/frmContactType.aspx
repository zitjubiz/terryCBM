...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmContactType.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmContactType"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                        <div id="navbar">
                            <span id="currentModule">
                                ...
                                &gt;
                                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:re, lblContactType%>" />
                            </span>
                        </div>
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="ID" Text="<%$ Resources:re, lblID%>"></asp:ListItem>		
											<asp:ListItem Value="ContactType" Text="<%$ Resources:re, lblContactType%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                ...
                                <Columns>
									<asp:BoundField DataField="ID"  SortExpression="ID" HeaderText="<%$ Resources:re, lblID%>" />		
									<asp:BoundField DataField="ContactType"  SortExpression="ContactType" HeaderText="<%$ Resources:re, lblContactType%>" />		
