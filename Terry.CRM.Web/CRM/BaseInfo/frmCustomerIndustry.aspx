...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerIndustry.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerIndustry"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="IndustryID" Text="<%$ Resources:re, lblIndustryID%>"></asp:ListItem>		
											<asp:ListItem Value="Industry" Text="<%$ Resources:re, lblIndustry%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="IndustryID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="IndustryID"  SortExpression="IndustryID" HeaderText="<%$ Resources:re, lblIndustryID%>" />		
									<asp:BoundField DataField="Industry"  SortExpression="Industry" HeaderText="<%$ Resources:re, lblIndustry%>" />		
