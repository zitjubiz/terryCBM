...
{
    public partial class frmCustomerType : BasePage
    {
        private const string EditURL = "frmCustomerTypeEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "CustTypeID":
                            Filter = "CustTypeID=" + ViewState["keyword"] + "";
                            break;
                        default:
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerType", out recordCount, Filter, gvData.OrderBy);
