...
{
    public partial class frmProvince : BasePage
    {
        private const string EditURL = "frmProvinceEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "ProvinceID":
                            Filter = " and CountryID=" + ViewState["keyword"] + "";
                            break;
                        default:
            ...
            DataTable ilist = svr.SearchByCriteria("CRMProvince",  out recordCount, Filter, gvData.OrderBy);
