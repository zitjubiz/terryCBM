<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCustomerFromEdit.aspx.cs"
    Inherits="Terry.CRM.Web.CRM.frmCustomerFromEdit" MasterPageFile="~/MasterPage/Site.Master" %>
                            ...
                            <div class="DetailDt">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblCustFrom" runat="server" Text="<%$ Resources:re, lblCustFrom %>"></asp:Label>
                                            :
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtCustFrom" runat="server" tip="<%$ Resources:re, MsgCustFrom%>"
