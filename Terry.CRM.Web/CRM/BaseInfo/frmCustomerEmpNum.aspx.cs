...
{
    public partial class frmCustomerEmpNum : BasePage
    {
        private const string EditURL = "frmCustomerEmpNumEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerEmpNum", out recordCount, Filter, gvData.OrderBy);
