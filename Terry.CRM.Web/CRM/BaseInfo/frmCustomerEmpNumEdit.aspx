<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmCustomerEmpNumEdit.aspx.cs"
    Inherits="Terry.CRM.Web.CRM.frmCustomerEmpNumEdit" MasterPageFile="~/MasterPage/Site.Master" %>
                            ...
                            <div class="DetailDt">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblEmpNum" runat="server" Text="<%$ Resources:re, lblEmpNum %>"></asp:Label>
                                            :
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtEmpNum" runat="server" tip="<%$ Resources:re, MsgEmpNum%>" usage="notempty"
                                                Width="100%">
