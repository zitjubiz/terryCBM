...
{
    public partial class frmCustomerFrom : BasePage
    {
        private const string EditURL = "frmCustomerFromEdit.aspx";
        ...
        private void BindData()
        {
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerFrom", out recordCount, Filter, gvData.OrderBy);
