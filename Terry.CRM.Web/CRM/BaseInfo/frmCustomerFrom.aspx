...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerFrom.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerFrom"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                        <div id="navbar">
                            <span id="currentModule">
                                ...
                                &gt;
                                <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:re, lblCustomerFrom%>" />
                            </span>
                        </div>
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="CustFrom" Text="<%$ Resources:re, lblCustFrom%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                ...
                                <Columns>
									...
									<asp:BoundField DataField="CustFrom"  SortExpression="CustFrom" HeaderText="<%$ Resources:re, lblCustFrom%>" />		
