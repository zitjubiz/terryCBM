...
{
    public partial class frmCustomerRelation : BasePage
    {
        private const string EditURL = "frmCustomerRelationEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "RelationID":
                            Filter = "RelationID=" + ViewState["keyword"] + "";
                            break;
                        default:
            ...
            DataTable ilist = svr.SearchByCriteria("CRMCustomerRelation",  out recordCount, Filter, gvData.OrderBy);
