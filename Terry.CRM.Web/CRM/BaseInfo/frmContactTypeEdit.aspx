<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmContactTypeEdit.aspx.cs"
    Inherits="Terry.CRM.Web.CRM.frmContactTypeEdit" MasterPageFile="~/MasterPage/Site.Master" %>
                            ...
                            <div class="DetailDt">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblContactType" runat="server" Text="<%$ Resources:re, lblContactType %>"></asp:Label>
                                            :
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtContactType" runat="server" tip="<%$ Resources:re, MsgContactType%>"
