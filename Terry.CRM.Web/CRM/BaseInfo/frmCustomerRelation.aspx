...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerRelation.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerRelation"
                    ...
                    <div id="main_content" class="content" style="width: 100%">
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="RelationID" Text="<%$ Resources:re, lblRelationID%>"></asp:ListItem>		
											<asp:ListItem Value="Relation" Text="<%$ Resources:re, lblRelation%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                HeaderStyle-CssClass="Head" RowStyle-CssClass="Row" DataKeyNames="RelationID" FooterStyle-CssClass="Foot"
                                ...
                                <Columns>
									<asp:BoundField DataField="RelationID"  SortExpression="RelationID" HeaderText="<%$ Resources:re, lblRelationID%>" />		
									<asp:BoundField DataField="Relation"  SortExpression="Relation" HeaderText="<%$ Resources:re, lblCustomerRelation%>" />		
