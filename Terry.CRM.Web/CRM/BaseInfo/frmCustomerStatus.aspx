...
<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="frmCustomerStatus.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmCustomerStatus"
                                ...
                                <table>
                                    <tr>
                                        <td style="padding-left: 10px">
											...
											<asp:ListItem Value="CustStatus" Text="<%$ Resources:re, lblCustStatus%>"></asp:ListItem>		
					                                            </asp:DropDownList>
                        ...
                        <div id="Grid">
                            <cc1:PagingGridView ID="gvData" runat="server" AutoGenerateColumns="False" CssClass="tableBorder"
                                ...
                                <Columns>
									...
									<asp:BoundField DataField="CustStatus"  SortExpression="CustStatus" HeaderText="<%$ Resources:re, lblCustStatus%>" />		
