...
{
    public partial class frmCategory : BasePage
    {
        private const string EditURL = "frmCategoryEdit.aspx";
        ...
        private void BindData()
        {
            ...
            if (ViewState["keyword"] != null)
            {
                if (!string.IsNullOrEmpty((String)ViewState["keyword"]))
                {
                    ...
                    {
                        case "CatID":
                            Filter = "CatID=" + ViewState["keyword"] + "";
                            break;
                        default:
                            Filter = ddlSearch.SelectedValue + " like '%" + ViewState["keyword"] + "%')";
                            break;
                    }
            ...
            if (OrderBy == "")
                OrderBy = "CatID";
            DataTable ilist = svr.SearchByCriteria(typeof(CRMCategory), gvData.PageIndex, base.GridViewPageSize, out recordCount, Filter, OrderBy);
