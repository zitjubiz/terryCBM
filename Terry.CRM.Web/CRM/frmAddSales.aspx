<%@ Page Language="C#" MasterPageFile="~/MasterPage/Site.Master" AutoEventWireup="true" CodeBehind="frmAddSales.aspx.cs" Inherits="Terry.CRM.Web.CRM.frmAddSales" Title="增加销售人员" %>
<asp:Content ID="Content1" ContentPlaceHolderID="CPH1" runat="server">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:DropDownList ID="txtDept" runat="server" tip="<%$ Resources:re, MsgDepName%>"
                                                usage="" Width="150px">
                                                <asp:ListItem Value="1">销售部</asp:ListItem>
                                            </asp:DropDownList>
                                        </td>
                                        <td>
    ...
    <asp:TextBox ID="txtUserID" runat="server" usage="notempty" Visible="false" Width="100%" />
</asp:Content>
