...
{
    public partial class Top10Cust : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Currency == "USD")
            {
                ...
                SqlDataSource1.SelectCommand = @"SELECT TOP 10 [CustName], 
...
Currency='USD'  FROM [vw_CRMCustomerDeal] " + Filter + " group by [CustID],[CustName] order by TotalAmount desc";
            }
...
Currency='EUR'  FROM [vw_CRMCustomerDeal]" + Filter + " group by [CustID],[CustName] order by TotalAmount desc";
...
Currency='RMB'  FROM [vw_CRMCustomerDeal] " + Filter + " group by [CustID],[CustName] order by TotalAmount desc";
            }
        }
    }
}